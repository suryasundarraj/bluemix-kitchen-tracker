...
kitchenTracker: kitchenYun/kitchenTracker.c $(SOURCEFILES) c-core/core/pubnub_ntf_sync.c
	$(CC) -o $@ $(CFLAGS) -D VERBOSE_DEBUG kitchenYun/kitchenTracker.c c-core/core/pubnub_ntf_sync.c $(SOURCEFILES) $(LDFLAGS) 
